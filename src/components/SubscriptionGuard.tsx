...
const CONFIG = {
    ...
    DEFAULT_FEATURE_SLUG: 'berita-acara'
};
...
// =========================================
export const clearSubscriptionSession = (featureSlug: string = 'berita-acara') => {
...
// =========================================
export const hasSubscriptionSession = (featureSlug: string = 'berita-acara'): boolean => {
    try {
